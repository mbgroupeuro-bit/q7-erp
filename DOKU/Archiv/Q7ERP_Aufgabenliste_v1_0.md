# Q7-ERP — AUFGABENLISTE (Stand: nach Konzeptions-Chat 1)

## Sofort umsetzbar (technischer Start)

| # | Aufgabe | Bezug |
|---|---|---|
| 1 | NestJS-Projekt unter `D:\Projekt2027\ERP System\` initialisieren | Setup-Schritte, Master-Dok Abschnitt Tech-Stack |
| 2 | Prisma installieren, `.env` mit PostgreSQL-Verbindung anlegen | Setup-Schritte |
| 3 | `schema.prisma` (bereits erstellt) einfügen und `npx prisma migrate dev` ausführen | Datei `schema.prisma` |
